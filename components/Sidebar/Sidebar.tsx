  ...
  return (
    ...
    >
      <div className="px-8 py-5 flex items-center gap-3 relative">
        ...
        {children?.title || <p>Admin</p>}
        {children?.button || (
          <button
            onClick={showHideSidebar}
            className="rounded-full p-3 h-[34px] w-[34px] bg-zinc-700 border border-white absolute -right-4"
          ></button>
        )}
      </div>
          ...
          <>
            ...
            <Navigation href="/admin/user" hasSubItem={true}>
              {{
                ...
                items: (
                  <>
                    <Navigation href="/admin/user">User{"'"}s Data</Navigation>
